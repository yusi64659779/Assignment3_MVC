@ModelType IEnumerable(Of Assignment3_MVC.Assignment3_MVC.Mushroom)
@Code
...
<table class="table">
    <tr>
        ...
        <th>
            @Html.DisplayNameFor(Function(model) model.Vegetable.Veg_Name)
        </th>
        <th></th>
    </tr>
...
@For Each item In Model
    @<tr>
        ...
        <td>
            @Html.DisplayFor(Function(modelItem) item.Vegetable.Veg_Name)
        </td>
        <td>
